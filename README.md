...
Cookie Site is a single-page application (SPA) that demonstrates a complete marketing and e‑commerce style front end for a bakery/cookie brand. It includes reusable components, a dynamic breadcrumb, accessible forms, and adaptable sections for real product data.
...
```
git clone <your_repo_url>.git cookie
cd cookie
```
