            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 mb-10 md:mb-0">
                        <h1 className="text-4xl md:text-5xl font-bold text-primary-900 mb-6 font-heading">Our Story of Passion & Pastry</h1>
                        <p className="text-lg text-primary-700 mb-8">Since 2010, we've been crafting exceptional cookies that bring joy to every bite. What started as a small family bakery has grown into a beloved community institution, but our commitment to quality and craftsmanship remains unchanged.</p>
                        <div className="flex space-x-4">
                            ...
                            <div className="bg-white rounded-lg p-4 text-center shadow-md">
                                ...
                                <span className="text-primary-600">Cookie Varieties</span>
                            </div>
                            <div className="bg-white rounded-lg p-4 text-center shadow-md">
                                <span className="block text-3xl font-bold text-secondary">10k+</span>
                                <span className="text-primary-600">Happy Customers</span>
                            </div>
                        </div>
                    </div>
