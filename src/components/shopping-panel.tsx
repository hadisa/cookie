import { Cookie, ShoppingBag, Trash, X } from "lucide-react";
...
const ShoppingPanel = () => {
  ...
  return (
    <div
      className={`cart-panel fixed top-0 right-0 h-full w-80 bg-white dark:bg-gray-800 shadow-lg transform ${
        cartOpen ? "translate-x-0" : "translate-x-full"
      } z-50 overflow-y-auto transition-transform duration-400`}
    >
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 pt-4 p-8">
        ...
        <Link
          to="/order"
          className="w-full p-2 bg-secondary hover:bg-primary-700 text-white rounded-lg font-medium transition-colors"
        >Checkout</Link>
      </div>
    </div>
  );
