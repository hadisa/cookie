        ...
        <section className="py-16">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-primary-900 mb-4 font-heading">Frequently Asked Questions</h2>
                    <p className="text-primary-700 max-w-2xl mx-auto">Find quick answers to common questions about our cookies, ordering process, and more.</p>
                </div>

                <div className="max-w-3xl mx-auto space-y-6">
                    <div className="bg-white rounded-xl shadow-md p-6">
                        <button className="flex justify-between items-center w-full text-left">
                            <h3 className="text-lg font-semibold text-primary-900">Do you offer gluten-free or vegan options?</h3>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6">
                        <button className="flex justify-between items-center w-full text-left">
                            <h3 className="text-lg font-semibold text-primary-900">How far in advance should I place a large order?</h3>
                            <ChevronDown className="text-primary-600" />

                        </button>
                        <div className="mt-4 text-primary-600 hidden">
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6">
                        <button className="flex justify-between items-center w-full text-left">
                            <h3 className="text-lg font-semibold text-primary-900">Do you ship cookies nationwide?</h3>
                            <ChevronDown className="text-primary-600" />
                        </button>
                        <div className="mt-4 text-primary-600 hidden">
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6">
                        <button className="flex justify-between items-center w-full text-left">
                            <h3 className="text-lg font-semibold text-primary-900">Can I customize a cookie assortment for a special event?</h3>
                            <ChevronDown className="text-primary-600" />
                        </button>
                        <div className="mt-4 text-primary-600 hidden">
