        ...
        <section className="py-16 bg-white dark:bg-gray-800">
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-bold text-primary-900 mb-4 font-heading dark:text-white">How It All Began</h2>
                    <p className="text-primary-700 max-w-2xl mx-auto dark:text-gray-300">Our journey started with a simple family recipe and a dream to share our love for baking with the world.</p>
                </div>
